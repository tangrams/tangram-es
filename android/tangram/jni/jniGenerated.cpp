...
SWIGEXPORT jdouble JNICALL Java_com_mapzen_tangram_TangramJNI_Properties_1getNumber(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2) {
  jdouble jresult = 0 ;
  Tangram::Properties *arg1 = (Tangram::Properties *) 0 ;
  std::string *arg2 = 0 ;
  std::shared_ptr< Tangram::Properties const > *smartarg1 = 0 ;
  ...
  arg2 = &arg2_str;
  jenv->ReleaseStringUTFChars(jarg2, arg2_pstr);
  result = (double)((Tangram::Properties const *)arg1)->getNumber((std::string const &)*arg2);
