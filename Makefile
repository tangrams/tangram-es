...
osx/lib/libtangram.so: core/tangram.cpp core/tangram.h
	clang++ -o osx/lib/libtangram.so core/tangram.cpp core/util/shaderProgram.cpp osx/src/platform_osx.cpp -Icore -DPLATFORM_OSX -lglfw3 -framework OpenGL -std=c++11 -shared
