...
struct SceneLoader {
    ...
    static bool loadScene(const std::shared_ptr<const Platform>& _platform, std::shared_ptr<Scene> _scene, const std::vector<SceneUpdate>& updates = {});
    static bool applyConfig(const std::shared_ptr<const Platform>& platform, const std::shared_ptr<Scene>& scene);
    ...
    static void loadSource(const std::shared_ptr<const Platform>& platform, const std::string& name,
                           const Node& source, const Node& sources, const std::shared_ptr<Scene>& scene);
    static void loadSourceRasters(const std::shared_ptr<const Platform>& platform, std::shared_ptr<TileSource>& source, Node rasterNode,
                                  const Node& sources, const std::shared_ptr<Scene>& scene);
    static void loadTexture(const std::shared_ptr<const Platform>& platform, const std::pair<Node, Node>& texture, const std::shared_ptr<Scene>& scene);
    ...
    static void loadStyleProps(const std::shared_ptr<const Platform>& platform, Style& style, Node styleNode, const std::shared_ptr<Scene>& scene);
    static void loadMaterial(const std::shared_ptr<const Platform>& platform, Node matNode, Material& material, const std::shared_ptr<Scene>& scene, Style& style);
    static void loadShaderConfig(const std::shared_ptr<const Platform>& platform, Node shaders, Style& style, const std::shared_ptr<Scene>& scene);
    static void loadFont(const std::shared_ptr<const Platform>& platform, const std::pair<Node, Node>& font, const std::shared_ptr<Scene>& scene);
    ...
    static bool loadTexture(const std::shared_ptr<const Platform>& platform, const std::string& url, const std::shared_ptr<Scene>& scene);
    static std::shared_ptr<Texture> fetchTexture(const std::shared_ptr<const Platform>& platform, const std::string& name, const std::string& url,
    ...
    static MaterialTexture loadMaterialTexture(const std::shared_ptr<const Platform>& platform, Node matCompNode,
    ...
    static bool parseStyleUniforms(const std::shared_ptr<const Platform>& platform, const Node& value,
                                   const std::shared_ptr<Scene>& scene, StyleUniform& styleUniform);

    static void parseLightPosition(Node position, PointLight& light);

    static bool loadStyle(const std::shared_ptr<const Platform>& platform, const std::string& styleName,
