...
namespace Builders {
     ...
     */
    void buildPolyLine(const Line& _line, float _halfWidth, std::vector<glm::vec3>& _pointsOut, std::vector<int>& _indicesOut, const std::string& _cap = "miter", const std::string& _join = "butt", bool _closed_polygon = false, bool _remove_tile_edges = false );
     ...
     * @_texcoordsOut 2D texture coordinates for each output coordinate are added to this vector
     */
    void buildPolyLine(const Line& _line, float _halfWidth, std::vector<glm::vec3>& _pointsOut, std::vector<int>& _indicesOut, std::vector<glm::vec2>& _texcoordsOut, const std::string& _cap = "miter", const std::string& _join = "butt", bool _closed_polygon = false, bool _remove_tile_edges = false );
     ...
     * @_indicesOut indices for drawing the polyline as triangles are added to this vector
     */
    void buildScalablePolyLine(const Line& _line, std::vector<glm::vec3>& _pointsOut, std::vector<glm::vec2>& _scalingVecsOut, std::vector<int>& _indicesOut, const std::string& _cap = "miter", const std::string& _join = "butt", bool _closed_polygon = false, bool _remove_tile_edges = false );
     ...
     * @_texcoordsOut 2D texture coordinates for each output coordinate are added to this vector
     */
    void buildScalablePolyLine(const Line& _line, std::vector<glm::vec3>& _pointsOut, std::vector<glm::vec2>& _scalingVecsOut, std::vector<int>& _indicesOut, std::vector<glm::vec2>& _texcoordsOut, const std::string& _cap = "miter", const std::string& _join = "butt", bool _closed_polygon = false, bool _remove_tile_edges = false );
