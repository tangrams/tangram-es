...
ClientGeoJsonSource::ClientGeoJsonSource(const std::string& _name, const std::string& _url, const std::string& _mbtiles,
                                         int32_t _minDisplayZoom, int32_t _maxDisplayZoom, int32_t _maxZoom)
    : DataSource(_name, _url, _mbtiles, _minDisplayZoom, _maxDisplayZoom, _maxZoom) {
