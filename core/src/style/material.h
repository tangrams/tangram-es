...
enum class MappingType { uv, planar, triplanar, spheremap };
...
public:
    ...
    void setEmission(const std::string& _file, MappingType _type = MappingType::uv, glm::vec3 _scale = glm::vec3(1.),
                     glm::vec4 _amount = glm::vec4(1.));
    void setEmission(std::shared_ptr<Texture> _texture, MappingType _type = MappingType::uv,
                     glm::vec3 _scale = glm::vec3(1.), glm::vec4 _amount = glm::vec4(1.));

    /*  Ambient color is by default disabled and vec4(1.0).
     *  Setting this property enables it and changes require reloading the shader. */
    void setAmbient(const glm::vec4 _ambient);
    void setAmbient(const std::string& _file, MappingType _type = MappingType::uv, glm::vec3 _scale = glm::vec3(1.),
                    glm::vec4 _amount = glm::vec4(1.));
    void setAmbient(std::shared_ptr<Texture> _texture, MappingType _type = MappingType::uv,
                    glm::vec3 _scale = glm::vec3(1.), glm::vec4 _amount = glm::vec4(1.));
    ...
    void setDiffuse(const std::string& _file, MappingType _type = MappingType::uv, glm::vec3 _scale = glm::vec3(1.),
                    glm::vec4 _amount = glm::vec4(1.));
    void setDiffuse(std::shared_ptr<Texture> _texture, MappingType _type = MappingType::uv,
                    glm::vec3 _scale = glm::vec3(1.), glm::vec4 _amount = glm::vec4(1.));
    ...
    void setSpecular(const std::string& _file, MappingType _type = MappingType::uv, glm::vec3 _scale = glm::vec3(1.),
                     glm::vec4 _amount = glm::vec4(1.));
    void setSpecular(std::shared_ptr<Texture> _texture, MappingType _type = MappingType::uv,
                     glm::vec3 _scale = glm::vec3(1.), glm::vec4 _amount = glm::vec4(1.));
    ...
    void setNormal(const std::string& _file, MappingType _type = MappingType::uv, glm::vec3 _scale = glm::vec3(1.),
                   float _amount = 1.);
    void setNormal(std::shared_ptr<Texture> _texture, MappingType _type = MappingType::uv,
                   glm::vec3 _scale = glm::vec3(1.), float _amount = 1.);
