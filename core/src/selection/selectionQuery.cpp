        ...
        case QueryType::label:
            {
                ...
                LngLat coordinate = label.first->coordinate(*label.second, _view.getMapProjection());

                LabelPickResult queryResult(label.first->renderType(), coordinate, FeaturePickResult(props, {{m_position.x, m_position.y}}));
