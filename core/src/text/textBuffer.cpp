...
bool TextBuffer::addLabel(const TextStyle::Parameters& _params, Label::Transform _transform,
    ...
    for (auto& q : quads) {
        ...
        vertices.push_back({{q.x0, q.y0}, {q.s0, q.t0}, {0, 0, 0}, _params.fill, stroke});
        vertices.push_back({{q.x0, q.y1}, {q.s0, q.t1}, {2, 0, 0}, _params.fill, stroke});
        vertices.push_back({{q.x1, q.y0}, {q.s1, q.t0}, {1, 0, 0}, _params.fill, stroke});
        vertices.push_back({{q.x1, q.y1}, {q.s1, q.t1}, {3, 0, 0}, _params.fill, stroke});
    }
