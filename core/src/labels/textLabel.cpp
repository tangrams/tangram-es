...
TextLabel::TextLabel(TileID _tileID, std::string _text, Label::Transform _transform, Type _type, glm::vec2 _dim,
                     TextBuffer& _mesh, Range _vertexRange, Label::Options _options)
    : Label(_tileID, _transform, _dim, _type, static_cast<LabelMesh&>(_mesh), _vertexRange, _options),
      m_text(_text) {}
