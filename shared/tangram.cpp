...
void logMsg(const char* fmt, const char* msg) { __android_log_print(ANDROID_LOG_DEBUG, "Tangram", fmt, msg); }
#endif

#ifdef PLATFORM_IOS
void logMsg(const char* fmt, const char* msg) { fprintf(stderr, fmt, msg); }
#endif
